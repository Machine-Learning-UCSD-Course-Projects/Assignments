function [cost_total,grad_total] = MyTest(theta, alpha_cat, cat_size, beta, dictionary_length, hiddenSize, ...
...
temp = theta1(5001,1);
theta1(5001,1) = temp + 1e-2;
[costRAE1, gradRAE, allKids] = computeCostAndGradRAE([], theta1, 0, alpha_cat, cat_size, beta, dictionary_length, hiddenSize, ...
    (alpha_cat)*lambda, We_orig , data_cell, labels, freq_orig, f, f_prime);

theta1(5001,1) = temp - 1e-2;
[costRAE2, gradRAE, allKids] = computeCostAndGradRAE([], theta1, 0, alpha_cat, cat_size, beta, dictionary_length, hiddenSize, ...
    (alpha_cat)*lambda, We_orig , data_cell, labels, freq_orig, f, f_prime);

dx2 = (costRAE2 - costRAE1) / (2e-2);
